Contributing to zXflea Core
============================

The zXflea Core project operates an open contributor model where anyone is
...
The following applies to code changes to the zXflea Core project, and is not to be
confused with overall zXflea Network Protocol consensus changes.

Whether a pull request is merged into zXflea Core rests with the project merge
...
Patches that change zXflea consensus rules are considerably more involved than
...
Where a patch set proposes to change the zXflea consensus, it must have been
...
The project leader is the release manager for each zXflea Core release.
