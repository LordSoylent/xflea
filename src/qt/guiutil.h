...
/** Utility functions used by the zXflea Qt UI.
 */
namespace GUIUtil
{
...
// Render zXflea addresses in monospace font
...
// Parse "zxflea:" URI into recipient object, return true on successful parsing
