                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("zXflea Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a zXflea address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and zxflea: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zXFLEA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About zXflea Core"), this);
    aboutAction->setStatusTip(tr("Show information about zXflea Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for zXflea"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your zXflea addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified zXflea addresses"));
    ...
    openAction->setStatusTip(tr("Open a zXflea: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the zXflea Core help message to get a list with possible zXflea command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("zXflea Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to zXflea network", "", count));
}
...
{
    QString strTitle = tr("zXflea Core"); // default title
