...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("zXflea Core zxflea-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  zxflea-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded zxflea transaction") + "\n" +
                               "  zxflea-tx [options] -create [commands]   " + _("Create hex-encoded zxflea transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded zxflea transaction
