...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* zXflea features */
        {"zxflea", "masternode", &masternode, true, true, false},
        {"zxflea", "listmasternodes", &listmasternodes, true, true, false},
        {"zxflea", "getmasternodecount", &getmasternodecount, true, true, false},
        {"zxflea", "masternodeconnect", &masternodeconnect, true, true, false},
        {"zxflea", "masternodecurrent", &masternodecurrent, true, true, false},
        {"zxflea", "masternodedebug", &masternodedebug, true, true, false},
        {"zxflea", "startmasternode", &startmasternode, true, true, false},
        {"zxflea", "createmasternodekey", &createmasternodekey, true, true, false},
        {"zxflea", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"zxflea", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"zxflea", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"zxflea", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"zxflea", "getmasternodescores", &getmasternodescores, true, true, false},
        {"zxflea", "mnbudget", &mnbudget, true, true, false},
        {"zxflea", "preparebudget", &preparebudget, true, true, false},
        {"zxflea", "submitbudget", &submitbudget, true, true, false},
        {"zxflea", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"zxflea", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"zxflea", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"zxflea", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"zxflea", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"zxflea", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"zxflea", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"zxflea", "checkbudgets", &checkbudgets, true, true, false},
        {"zxflea", "mnsync", &mnsync, true, true, false},
        {"zxflea", "spork", &spork, true, true, false},
        {"zxflea", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"zxflea", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use zxflead, or the -server option to zxflea-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> zxflea-cli " + methodname + " " + args + "\n";
}
