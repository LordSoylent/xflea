...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (     0, uint256("0x000008c9ed02bf5e65c36c55d9737023542eef83eef1fdaedda3ce4894e004f5"));

static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1529203666, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 44777;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // zXflea starting difficulty is 1 / 2^12
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1529203666;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 2809536;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x000008c9ed02bf5e65c36c55d9737023542eef83eef1fdaedda3ce4894e004f5"));
        assert(genesis.hashMerkleRoot == uint256("0x05ae9c76b37cf6b211c3f8cc874c08f2abd67d5c032e9662d9884c075fc74adb"));

	vSeeds.push_back(CDNSSeedData("45.63.39.241", "45.63.39.241"));
        vSeeds.push_back(CDNSSeedData("144.202.124.166", "144.202.124.166"));
        vSeeds.push_back(CDNSSeedData("45.77.67.233", "45.77.67.233"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // zXflea: 1 day
        nTargetSpacing = 1 * 60;  // zXflea: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 10;
	...
	hashGenesisBlock = genesis.GetHash();
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet zxflea addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet zxflea script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet zxflea BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet zxflea BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet zxflea BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // zXflea: 1 day
        nTargetSpacing = 1 * 60;        // zXflea: 1 minutes
