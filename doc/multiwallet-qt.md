...
In order to support loading of multiple wallets in zxflea-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is zxflea.cpp.
...
Changes to zxflea.cpp
----------------------
zxflea.cpp is the entry point into zxflea-qt, and as such, will require some minor modifications to provide hooks for
