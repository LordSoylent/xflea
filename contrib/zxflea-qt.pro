...
RESOURCES += src/qt/zxflea.qrc src/qt/zxflea_locale.qrc

TRANSLATIONS += src/qt/locale/zxflea_bg.ts \
                src/qt/locale/zxflea_de.ts \
                src/qt/locale/zxflea_en.ts \
                src/qt/locale/zxflea_es.ts \
                src/qt/locale/zxflea_fi.ts \
                src/qt/locale/zxflea_fr.ts \
                src/qt/locale/zxflea_it.ts \
                src/qt/locale/zxflea_ja.ts \
                src/qt/locale/zxflea_pl.ts \
                src/qt/locale/zxflea_pt.ts \
                src/qt/locale/zxflea_ru.ts \
                src/qt/locale/zxflea_sk.ts \
                src/qt/locale/zxflea_sv.ts \
                src/qt/locale/zxflea_vi.ts \
                src/qt/locale/zxflea_zh_CN.ts \
                src/qt/locale/zxflea_zh_TW.ts
